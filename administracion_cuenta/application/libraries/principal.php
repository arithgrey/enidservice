<?php if (!defined('BASEPATH')) exit('No permitir el acceso directo al script');
	...
	class principal extends CI_Model implements  iRegistro{	 			
		...
		function get_tareas_soporte($id_usuario){
			...
			return $result->result_array()[0]["num_tareas"];
		}
		/**/
		function get_tickets_usuario($id_usuario){
			...
			$result =  $this->db->query($query_get);
			return $result->result_array()[0]["num_tickets"];
		}
		/**/
		function get_num_proyectos_persona($id_usuario){

        	$query_get ="SELECT count(0)num_proyectos 
        				 FROM  
        				 proyecto_persona 
        				 WHERE id_usuario = '".$id_usuario."' ";

        	$result =  $this->db->query($query_get);
			return $result->result_array()[0]["num_proyectos"];

    	}	
    	/**/
		function get_id_persona($id_usuario){

			$query_get ="SELECT  
							id_persona ,  
							id_usuario_enid_service 
						FROM 
							persona 
						WHERE 
