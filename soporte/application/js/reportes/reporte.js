...
function registra_incidencia(e){
    ...
    if (get_option("calificacion") > 0 ){        
        ...
        if (flag_form ==  1  ){        
            ...
            data_send =  $(".form-error").serialize()+ "&" + $.param({"num_calificacion" : get_option("calificacion") });
...
function asigna_calificacion(e){  
    ...
    set_option("calificacion", n_calificacion);    
...
function valida_calificacion(){
    ...
    if (get_option("calificacion") == 0 ){
        ...
        return get_option("calificacion");
    }else{
