...
if ( ! function_exists('url_formas_pago_tienda_linea')){
	
	function url_formas_pago_tienda_linea(){
		return "../formas_de_pago/?q=2";    
	}
}
...
{
	function anchor_enid($uri = '', $title = '', $attributes = '')
	{
		$title = (string) $title;
