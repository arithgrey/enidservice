<?php if (!defined('BASEPATH')) exit('No permitir el acceso directo al script');
	...
	class principal extends CI_Model implements  iRegistro{	 			
		        ...
		        if (count($responsedb) == 1){
		            /*Crear session*/ 
			            ...
			            if($status == 0){
			            	...
			            	$data_complete["in_session"] =0;			            	
			        		$data_complete["mensaje"] = "
			        									<span class='error_login'>
			        										Usuario suspendido, 
			        										para mayores informes 
					        								<a href='../contacto' 
					        									class='strong blue_enid_background' style='padding:5px;'>
					        									aquí
					        								</a>
					        							</span>
					        							"; 
		            ...
		            /*Response data error*/        
		            $data_complete["in_session"] =0;			            
		            $data_complete["mensaje"] ="<span class='error_login'> 
    	...
    	function createsession($id_usuario, $nombre , $email){
	        ...
	        $data_complete["in_session"] =1;
	       	$data_complete["data_session"]= $this->session->set_userdata($newdatasession);
	       	return $data_complete;                                          
