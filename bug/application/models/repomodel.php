...
class repomodel extends CI_Model {
	...
	function insert_incidencia($param){
		...
		$descripcion_tarea ="Descripción ". $descripcion . " Página afectada: " . $pagina_error	
		."Tipo incidencia: ". $tipo_incidencia." Error(Mejora):  " . $afectacion." Calificación: ".
		$num_calificacion;		
		/**/
		$query_insert ="INSERT INTO tarea(
							 descripcion ,
							 id_ticket ,
							 usuario_registro 
		...
		$query_update ="UPDATE ticket SET status =0 WHERE id_ticket = 142 LIMIT 1";
