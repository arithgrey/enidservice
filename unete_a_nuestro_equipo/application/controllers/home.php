...
class Home extends CI_Controller{
    ...
    function index(){
        ...
        $data = $this->val_session("¿Sabías que puedes aumentar tus ingresos sólo por recomendar? ");
        
        $data["meta_keywords"] = 'Diseñor de páginas web,Tecnologías de la información,Google adwords,Diseño web df,diseño,mexico,paginas,portal,desarrollo ,software,diseño web,web diseño,paginas web,diseño portal,portal web,mexico,posicionamiento,móviles,desarrollo web df,desarrollo de portales web,paginas web administrables,gestor de contenidos,CMS,Posicionamiento web ,software a la medida ,tienda en linea,CRM ';
        ...
        $this->principal->crea_historico($num_hist , $num_usuario , $num_servicio );         
