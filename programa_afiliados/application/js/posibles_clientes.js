...
function carga_posibles_clientes(e){	
	...
	url =  "../persona/index.php/api/posiblesclientes/usuario_campo/format/json/";	
	data_send =  $(".form_busqueda_posibles_clientes").serialize();
	...
	if (flag_hora_agenda ==  1) {
		if (flag_fecha_agenda ==  1 ) {
			...
			$.ajax({
				...
				/*Aquí se muestra el tab deposibles clientes*/
...
/**/
function set_tmp_tel(n_tmp_tel){	
	tmp_tel = n_tmp_tel;
}
/**/
function get_tmp_tel(){
	return tmp_tel;
}