...
function notifica_pago(e){
	...
	if (flag > 0 ){
		...
		if(flag == 0 ){
			...
			var url 		=  "../pagos/index.php/api/cobranza/notifica_pago_usuario/format/json/";	
...
/**/
function response_notificacion_pago(data){
...
/***/
function response_notificacion_registro_pago(data){
...
function response_autocomplete(data){
...
function notifica_recibo_en_proceso(saldo_cubierto , monto_a_pagar){
...
/**/
function set_id_servicio(id_servicio){		
