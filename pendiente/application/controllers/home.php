...
{   
    ...
    private function bancos()
    {
        ...
        return $this->app->api("banco/index/format/json/");
    }   

    private function cuenta_pago($id_usuario)
    {
        
        return $this->app->api("cuenta_pago/id/format/json/",["id_usuario" => $id_usuario]);

    }   
    private function solicitud_retiro($id_usuario)
    {
        
        return $this->app->api("solicitud_retiro/id/format/json/",["id_usuario" => $id_usuario]);
