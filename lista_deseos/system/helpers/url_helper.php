...
if ( ! function_exists('url_adwords')){
	
	function url_adwords(){
		return "http://enidservice.com/inicio/adwords/";    
	}
}
if ( ! function_exists('url_crm')){
	
	function url_crm(){
		return "http://enidservice.com/inicio/crm/";    
	}
}


if ( ! function_exists('url_tiendas_en_linea')){
	
	function url_tiendas_en_linea(){
		return "http://enidservice.com/inicio/tienda_en_linea/";    
	}
}


if ( ! function_exists('url_paginas_web')){
	
	function url_paginas_web(){
		return "http://enidservice.com/inicio/paginas_web/";    
	}
}
