...
/**/
function create_select_selected($data , $campo_val, $campo_text , $selected , $name ,  $class , $extra='' ){

    $select ="<select class='".$class."' name='".$name."' $extra >"; 
    foreach ($data as $row ){
  ...
  /**/
  function create_select_selected_f($data , $campo_val, $campo_text , $selected , $name ,  $class , $id_persona , $campo ){

    $select ="<select 
              class='".$class."' 
              name='".$name."' 
              onchange='actualiza_info_campo_change(this , $id_persona , $campo )' >"; 
