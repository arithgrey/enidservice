...
if ( ! function_exists('url_back_to_the_events')){
	
	function url_back_to_the_events(){
		return "http://www.enidservice.com/back_to_the_events";    
	}
}

/**/
if ( ! function_exists('url_ranking_quality')){
	
	function url_ranking_quality(){
		return "http://www.enidservice.com/ranking_quality";    
	}
}
...
if ( ! function_exists('url_blog')){
	...
	function url_blog(){
		return "http://www.enidservice.com/blog/blog";    
	}
}
/**/
if ( ! function_exists('url_time_wallet')){
	
	function url_time_wallet(){
		return "http://www.enidservice.com/time_wallet";    
	}
}
...
if ( ! function_exists('url_busqueda_eventos')){
	function url_busqueda_eventos(){
		return  base_url('index.php/eventos/busqueda'); 
	}	
}
/**/
/**/
