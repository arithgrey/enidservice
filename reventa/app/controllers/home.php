...
class Home extends CI_Controller
{
    ...
    private function clientes($id_vendedor)
    {
        ...
        $clientes = $this->app->api("recibo/reventa",
            [
    ...
    private function intentos_reventa()
    {
        ...
        return $this->app->api("usuario_servicio_propuesta/intentos", []);
    ...
    private function usuarios_numero_compras($usuarios){
        ...
        if (es_data($usuarios)){
            ...
            foreach ($usuarios as $row){
                ...
                $num_compras = $this->app->api("recibo/num_compras_usuario", ["id_usuario" => $row["id_usuario"]]);
                $response[$a] =  $row;
