...
if (!function_exists('invierte_date_time')) {
    ...
    if (!function_exists('render_procesar')) {
        function render_procesar($data)
        {
            ...
            $r[] = d(d(d(append($z), "contenedo_compra_info"), "contenedor_compra"), "col-lg-8 col-lg-offset-2 top_100");
        ...
        function frm_primer_registro($in_session, $is_mobile, $info_ext)
        {
            ...
            if ($in_session < 1) {
                ...
                $r[] = d(a_enid("TU USUARIO YA SE ENCUENTRA REGISTRADO",
                    [
                        'class' => "white usuario_existente display_none  black_enid_background padding_1 white top_20 enid_hide",
    ...
    if (!function_exists('frm_contacto_servicio')) {
        ...
        function frm_contacto_servicio($in_session, $servicio)
        {
            ...
            if ($in_session < 1) {
                ...
                $r[] = contaiter(d(span("SOBRE: ", "underline") . $servicio["nombre_servicio"], 12), "mt-3 mb-3");
                ...
                $r[] = contaiter(d("¿Deseas agregar algún comentario?", "top_30 strong text_agregar_comentario cursor_pointer"), 1);
                $r[] = contaiter(textarea(["name" => "descripcion", "class" => "d-none descripcion_comentario"]), 1);
