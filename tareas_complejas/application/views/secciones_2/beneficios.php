  ...
  <div>
            ...
            <div >
                ...
                <div class="email_body">
                    ...
                    <p style="font-size: .9em; padding: 10px; background:#f8f4f4;" >
                    Una de las características que definimos al iniciar cada proyecto, es que su equipo podrá maximizar el retorno de la inversión para su empresa desde las primeras semanas, gracias al desarrollo de software gradual, es decir,
                    <strong>
                     podrán utilizar las funcionalidades más importantes del proyecto antes de que esté finalizado por completo. 
                     </strong>
                    </p>
