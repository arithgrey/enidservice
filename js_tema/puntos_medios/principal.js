...
let muestra_lineas_metro = function(tipo){
	
	let url  	   	= "../q/index.php/api/linea_metro/index/format/json/";	
	let servicio 	=  get_parameter(".servicio"); 		
	let data_send  	= {"v":1, tipo:tipo, "servicio":servicio};
	set_option("tipo" , tipo);
	request_enid( "GET",  data_send, url, response_lineas_metro);

};
let response_lineas_metro = function(data){	
