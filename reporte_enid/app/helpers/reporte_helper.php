...
if (!function_exists('invierte_date_time')) {
    ...
    function actualizaciones_del_dia($data)
    {
        ...
        $totales_accesos[] = d(flex("Anunciarse en Enid", place("click_anunciar_enid_place"), _text_(_between, "f12 black borde_end_b underline"), "", "strong f11"));
        
        $totales_accesos[] = d(flex("Vender auto", place("click_vender_auto_place"), _text_(_between, "f12 black borde_end_b underline"), "", "strong f11"));
    ...
    function format_productos_solicitados()
    {
        $form = base_busqueda_form(
            ...
            'form_busqueda_productos_solicitados',
            'place_keywords'
        );
    ...
    {
        $form = base_busqueda_form(
            'ACCESOS POR ARTÍCULOS',
            'form_busqueda_accesos_pagina_productos',
            'place_keywords'
        );
    ...
    function format_accesos_franja_horaria()
    {
        $form = base_busqueda_form(
            ...
            'form_busqueda_accesos_franja_horaria',
            'place_keywords'
        );
    ...
    function format_accesos_time_line()
    {
        $form = base_busqueda_form(
            'ACCESOS TIMELINE',
            'form_busqueda_accesos_time_line',
            'place_keywords'
        );
    ...
    {
        $form = busqueda_arquetipo(
            $data['tipo_tag_arquetipo'],
            'HISTORIAS DE USUARIO (ARQUETIPOS)',
            'form_arquetipos',
            'place_keywords'
        );
    ...
    {
        $form = base_busqueda_form(
            'VENTAS POR COMISIONISTAS',
            'form_ventas_comisionistas',
            'place_keywords'
        );
    ...
    function format_sin_ventas()
    {
        ...
        $form = base_busqueda_form(
            'Articulos sin venta (requieren atención)',
            'form_sin_ventas',
            'place_keywords',
            $ayer,
            $hoy
    ...
    function format_motivos_cancelaciones()
    {
        ...
        $form = base_busqueda_form(
            'MOTIVOS CANCELACIONES',
            'form_motivos_cancelaciones',
            'place_keywords'
        );
    ...
    function format_actividad()
    {
        ...
        $form = base_busqueda_form(
            'USUARIOS',
            'f_actividad_productos_usuarios',
            'repo_usabilidad'
        );
    ...
    function crea_repo_categorias_destacadas($param)
    {
        ...
        foreach ($param as $row) {
            ...
            $r[] = d(flex(
                $total,
                $clasificacion,
                'mt-2 justify-content-between align-items-center'
            ), 4, 1);
        }
    ...
    function menu()
    {
        ...
        $list = [
            ...
            a_enid(
                text_icon(_money_icon, "Ventas por alcaldías"),
                [
            ...
            a_enid(
                text_icon(_money_icon, "Próximas entregas"),
                [
            ...
            a_enid(
                text_icon(_money_icon, "Puntos de ventas clientes"),
                [
            ...
            a_enid(
                text_icon("fa-shopping-bag", "compras"),
                [
                    "id" => "btn_servicios",
            ...
            a_enid(
                text_icon('fa fa-clock-o', "tiempo de venta"),
                [
