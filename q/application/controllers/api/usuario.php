...
class usuario extends REST_Controller
{
    ...
    private function notifica_registro_exitoso($q)
    {
        ...
        return $this->app->api("emp/solicitud_afiliado/format/json/", $q);
    ...
    private function get_nun_activos_con_direcciones($q)
    {
        ...
        return $this->app->api("usuarios_direccion/activos_con_direcciones/format/json/", $q);
    ...
    private function get_agregan_clasificaciones_periodo($q)
    {
        ...
        return $this->app->api("usuario_clasificacion/agregan_clasificaciones_periodo/format/json/", $q);
    ...
    private function agregan_lista_deseos_periodo($q)
    {
        ...
        return $this->app->api("usuario_deseo/agregan_lista_deseos_periodo/format/json/", $q);
    ...
    private function agregan_img_perfil($q)
    {
        ...
        return $this->app->api("imagen_usuario/img_perfil/format/json/", $q);
    }
    ...
    private function get_preguntas($q)
    {
        ...
        return $this->app->api("pregunta/periodo/format/json/", $q);
