	...
	function get_social_icons()
	{
		...
		$r[] = anchor_enid(
			...
			[
				...
				"data-clipboard-text" => get_url_productos_cuenta_usuario_web($id_usuario)],
			1
		);
		$r[] = anchor_enid(
		...
		$r[] = anchor_enid(
			get_url_tumblr(get_url_productos_cuenta_usuario_web($id_usuario)), "icon('fa fa-tumblr  black')");
