<?= div("Primero que nada un cordial saludo ") ?>
...
<?= div("No me queda más que pedirle que nos envíe sus comentarios o si así lo prefiere evalúe nuestros servicios ") ?>
<?= anchor_enid("en este enlace.",
	["href" => "https://goo.gl/DTHQid",
		"style" => "background: blue;color: white;padding: 5px;"
	]) ?>

<?= anchor_enid("Le recordamos que puede acceder a su cuenta Enid Service a través de este enlace",
	[
