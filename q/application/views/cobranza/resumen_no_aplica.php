...
$url_logo               = "http://enidservice.com/inicio/img_tema/enid_service_logo.jpg";
...
$img_pago_oxxo = "http://enidservice.com/inicio/img_tema/pago-oxxo.jpeg";
$img_pago_paypal = "http://enidservice.com/inicio/img_tema/explicacion-pago-en-linea.png";
$url_seguimiento_pago = $url_request . "pedidos/?seguimiento=$id_recibo&notificar=1";

?>
<div style="width: 76%;">
    <?=get_saludo($cliente , $config_log , $id_recibo);?>
    <?=get_text_saldo_pendiente($resumen_pedido , $num_ciclos_contratados, $flag_servicio, $id_ciclo_facturacion , $text_envio_cliente_sistema , $primer_registro , $fecha_vencimiento , $monto_a_pagar , $saldo_pendiente );?>
    <?=get_text_forma_pago($img_pago_oxxo , $url_pago_oxxo , $url_pago_paypal , $img_pago_paypal)?>
    <?=get_text_notificacion_pago($url_seguimiento_pago , $url_cancelacion );?>
</div>