	...
	<?php
		...
		<?php				
			...
			foreach($l_fechas as $row){
				...
				$ft = $fecha_registro_texto ."<br>".$fecha_registro;
...
<table border="1" class="text-center" style="font-size: .8em;">
	<tr style="background: #0022B7;color: white;">
		<?=get_td("Periodo")?>
		<?=get_td("Totales <br> Días ".$num_dias)?>		
		<?=$seccion_fechas?>
	</tr>
	<tr>
		<?=get_td("Envios")?>		
