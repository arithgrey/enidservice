<?php
	...
	foreach ($info_afiliaciones as $row) {
		...
		$lista_solicitudes 	.=   
		get_td(valida_valor_por_fecha($fecha , "solicitudes" , $ventas ), "");
		
		$lista_ventas 		.=   
		get_td(valida_valor_por_fecha($fecha,"ventas_efectivas",$ventas ),"");

		$lista_accesos 		.=   
		get_td(valida_valor_por_fecha($fecha,"num_accesos",$accesos ),"");
