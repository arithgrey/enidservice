...
if (!function_exists('invierte_date_time')) {
    ...
    function simular($data)
    {
        ...
        $metricas[] = d(_text_("Utilidad", money(($utilidad_venta - $otro))),"col-sm-4 text-right");        
        $response[] = d($metricas, "row mt-3 border-bottom black");


        $metricas  = [];
        $metricas[] = d("5 días",4);
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 5) - $otro )),"col-sm-4");
        $metricas[] = d(_text_("Utilidad", money(($utilidad_venta * 5))),"col-sm-4 text-right");        
        $response[] = d($metricas, "row mt-3 border-bottom black");

        $metricas  = [];
        $metricas[] = d("7 días",4);
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 7) - $otro )),"col-sm-4");
        $metricas[] = d(_text_("Utilidad", money(($utilidad_venta * 7))),"col-sm-4 text-right");        
        $response[] = d($metricas, "row mt-3 border-bottom black");
        
        $metricas  = [];
        $metricas[] = d("15 días",4);
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 15) - $otro )),"col-sm-4");
        ...
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 20) - $otro )),"col-sm-4");
        $metricas[] = d(_text_("Utilidad", money(($utilidad_venta * 20))),"col-sm-4 text-right");        
        $response[] = d($metricas, "row mt-3 border-bottom black");

        $metricas  = [];
        $metricas[] = d("22 días",4);
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 22) - $otro )),"col-sm-4");
        ...
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 30) - $otro )),"col-sm-4");
        ...
        $metricas  = [];
        $metricas[] = d("1 año",4);
        $metricas[] = d(_text_("#Ventas", ( ($cantidad_venta * 365) - $otro )),"col-sm-4");
