function cargar_info_agendados_email(){

	url =  "../base/index.php/api/ventas_tel/agendadosemail/format/json/";	
...
function registrar_correo_hecho(e){
	...
	url =  "../base/index.php/api/ventas_tel/agendados_correo_hecho/format/json/";		
...
/**/
function agenda_correo(e){


	flag_fecha_agenda =  valida_text_form(".contenedor_persona_registrada_correo .input_f_agenda" , ".contenedor_persona_registrada_correo .place_place_validador_fecha_agenda" , 5 , "Formato de fecha" );
	flag_hora_agenda =  valida_text_form(".contenedor_persona_registrada_correo .input_h_agenda" , ".contenedor_persona_registrada_correo .place_place_validador_hora_agenda" , 3 , "Formato de hora" );
	...
	if (flag_fecha_agenda ==  1) {
		...
		if (flag_hora_agenda == 1 ) {
			...
			url =  "../persona/index.php/api/persona/agendar_email/format/json/";		
			data_send =  $(".form_agendar_correo_electronico").serialize()+"&"+$.param({id_persona : get_persona() });	
