function carga_clientes(e){	
	...
	data_send =  $(".form_busqueda_clientes").serialize()+"&"+$.param({"tipo" : 2 , "usuario_validacion" : 1 , "mensual" : 0 });					
