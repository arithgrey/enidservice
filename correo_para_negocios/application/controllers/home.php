...
class Home extends CI_Controller{
    ...
    function index(){
        ...
        $data = $this->val_session("Puntualiza en qué posición del mercado se encuentra tu negocio,
                Correo corporativo como ventas@suempresa.com 
                ");    
        
        $data["meta_keywords"] = "";

        $data["desc_web"] = "Puntualiza en qué posición del mercado se encuentra tu negocio,
                Correo corporativo como ventas@suempresa.com ";        
                            
        $data["url_img_post"] = create_url_preview("correo_empresarial.png");
        ...
        /**/    
        /**/
        $data["planes_correos"]=  $this->principal->get_planes_correos();
        /**/
        $clasificaciones_departamentos =   $this->get_departamentos("nosotros");        
        $data["clasificaciones_departamentos"] = $clasificaciones_departamentos;

        $this->principal->crea_historico($num_hist , $num_usuario , $num_servicio , $id_mensaje);
