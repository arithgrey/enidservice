<?php if (!defined('BASEPATH')) exit('No permitir el acceso directo al script');
	...
	class principal extends CI_Model implements  iRegistro{	 					
		...
		/**/
	    /**/
	    function registra_email_enviado($email , $contenido_correo){
	        
	      $mensaje =  $contenido_correo["mensaje"];
	      $asunto =  $contenido_correo["asunto"];
	      $correo_invalido = $contenido_correo["correo_invalido"];
	      	
	        $query_insert = "INSERT IGNORE INTO email_prospecto(mensaje, asunto  , email_prospecto
	              )
	              VALUES(
	                '$mensaje' , 
	                '$asunto', 
