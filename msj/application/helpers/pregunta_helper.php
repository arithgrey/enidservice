...
if (!function_exists('invierte_date_time')) {
    ...
    function get_notificacion_interes_compra($vendedor)
    {
        ...
        $respónse[] = d(img(_text("http://enidservices.com/", _web, "/img_tema/enid_service_logo.jpg")), ["style" => "width: 30%;margin: 0 auto;"]);
    ...
    function get_notificacion_respuesta_cliente($cliente)
    {
        ...
        $r[] = a_enid("Mira la respuesta aquí!", ["href" => _text("http://enidservices.com/", _web, "/login/")]);
        $r[] = d(
            img(_text("http://enidservices.com/", _web, "/img_tema/enid_service_logo.jpg")),
            [
    ...
    function get_accesos($q)
    {
        ...
        $r[] = d(
            img([
                "src" => _text("http://enidservices.com/", _web, "/img_tema/enid_service_logo.jpg"),
                "style" => "width: 100%"
            ]),
            [
                "style" => "width: 30%;margin: 0 auto;"
