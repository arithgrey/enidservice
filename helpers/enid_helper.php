...
if (!function_exists('btn')) {
    function btn($info, $attributes = [], $row = 1, $type_button = 1, $submit = 1, $anchor = 0)
    {
        ...
        if ($type_button == 1) {
            ...
            $attributes["class"] =
                (array_key_exists("class", $attributes) ? 1 : 0 == 1) ? $attributes["class"]
...
if (!function_exists('input_hour_date')) {
    ...
    function input_hour_date()
    {
        ...
        $r[] = hiddens(["id" => "dtp_input1", "name" => "hora_fecha", "class" => "hora_fecha"]);
        return d(append($r),
            [
...
function contaiter($str, $attributes = [], $fluid = 1)
{
    ...
    if (intval($attributes) && $attributes > 0) {
        ...
        if (is_string($attributes)) {
            ...
            $att["class"] = (array_key_exists("class", $attributes)) ? add_text($attributes["class"], $f, 1) : $f;
        }
