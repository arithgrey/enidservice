...
<?php  
    ...
    $tareas_pendientes =
    "class='strong white ver_detalle_ticket blue_enid_background' id='".$id_ticket."' ";
    $id_usuario = $row["id_usuario"];		
            ...
            <div class="popup-head">
              <div class="popup-head-left pull-left">
                <img 
                  ...
                  <div>
                    <span style="font-size: .7em!important; color: black;">
              ...
              <div class="popup-head-right pull-right ">
                <div class="btn-group">
                        ...
                        <li>
                            <a <?=$tareas_pendientes?> style='color: white!important;'>
                              Agregar tareas
                            </a>
                        </li>                        
                        </ul>
