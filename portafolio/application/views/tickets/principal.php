<?php	
	...
	$l =  "";
	$l.= "<tr>";	    
	    $l.= get_td("Más info", "class='blue_enid_background white' style='font-size:.8em;'  ");
	    $l.= get_td("Estado", "class='blue_enid_background white' style='font-size:.8em;'  ");
	    $l.= get_td("T.pendientes",
	     "class='blue_enid_background white' style='font-size:.8em;'  ");
	     
	    $l.= get_td("Departamento", "class='blue_enid_background white' style='font-size:.8em;'  ");
	    $l.= get_td("Proyecto", "class='blue_enid_background white' style='font-size:.8em;'  ");
	    
	    
	    $l.= get_td("Asunto", "class='blue_enid_background white' style='font-size:.8em;'  ");
	                        
	    $l.= get_td(" Última solicitud", "class='blue_enid_background white' style='font-size:.8em;'  ");                      
	...
	foreach ($info_tickets as $row) {
		...
		$btn_mas_info ="<a class='strong white ver_detalle_ticket blue_enid_background' id='".$id_ticket."' style='padding:2px;font-size:.8em;'>Ver</a>";
		...
		$l.= "<tr>";	    
			...
			$l.= get_td($lista_status[$status] . " <i class='".$class_estatus_iconos[$status]."'>
		    	<i>" , " class='".$class_estatus[$status]."' style='font-size:.8em;' ");
