    <div 
        ...
        style="background-image:url('../img_tema/afiliados/afiliados.png')">
                ...
                <div class="wizard-container">
                    <div class="card wizard-card" data-color="red" id="wizard">
                          ...
                          <div class="wizard-header">
                              ...
                              <h5 class="blue_enid_background white">
                                Solicita una visita en tu negocio o cotiza en línea 
                                <a href="../precios_sitios_web" class="strong" 
                                style="color: white!important;"> aquí </a>
                              </h5>
                          </div>
    ...
    <?=n_row_12()?>    
      ...
      <div class="col-lg-6">        
          ...
          <input 
            ...
            required            
            >
            <span class="place_nombre_info"></span>  
          </div>
      ...
      <div class="col-lg-6">        
          ...
          <input 
            ...
            type="tel"
            value="" 
            onkeyup="quita_espacios_en_input_num();" 
            required  
